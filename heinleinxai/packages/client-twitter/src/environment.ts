...
export const twitterEnvSchema = z.object({
    ...
    TWITTER_ENDPOINT_DB_URL: z.string().url("INSERT ENDPOINT URL").optional(),
...
export async function validateTwitterConfig(
    ...
    try {
        const twitterConfig = {
            ...
            TWITTER_ENDPOINT_DB_URL:
                runtime.getSetting("TWITTER_ENDPOINT_DB_URL") ||
                process.env.TWITTER_ENDPOINT_DB_URL,
        };
